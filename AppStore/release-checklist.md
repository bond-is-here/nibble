...
- [x] Profile provides an explicit, fail-closed JSON diary export through Apple’s system Files/share flow. The snapshot is immutable after preparation, and unreadable archives cannot be exported as empty replacements; destination handling and deletion remain user-controlled.
